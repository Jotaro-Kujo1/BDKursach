...
public class GetSpecialityController implements ToPane, ToGetError, ToJson{
    ...
    void initialize() {
        ...
        getButton.setOnAction( event -> {
            Speciality speciality = specialityDomain.get(Integer.parseInt(IdTextArea.getText()));
            if(speciality!=null) {
