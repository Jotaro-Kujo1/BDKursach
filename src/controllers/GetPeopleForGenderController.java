...
public class GetPeopleForGenderController implements ToGetError, ToPane, ToJson{
    ...
    void initialize() {
        ...
        getButton.setOnAction(event -> {
            unemployedList = unemplDomain.getPeopleForGender(db.genderTransformation(genderTextArea.getText()));
