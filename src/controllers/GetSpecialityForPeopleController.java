...
public class GetSpecialityForPeopleController implements ToGetError, ToPane, ToJson{
    ...
    @FXML
    private TextField peopleTextArea;
    ...
    void initialize() {
        ...
        getButton.setOnAction(event -> {
            //unemployedList = unemplDomain.getPeopleForSpeciality(specialityDomain.transformation(specialityTextArea.getText()));
            specialityList = specialityDomain.getSpecialityForPeople(Integer.parseInt(peopleTextArea.getText()));
